...
Include section headings. Exclude the article title and editorial notes
before passing the text to this script. Markdown must be converted to
visible plain text by the caller.
"""
...
def main() -> int:
    ...
    parser.add_argument("--min-length", type=int, default=1100)
